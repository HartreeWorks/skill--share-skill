...
A Claude Code skill for converting private skills into public GitHub repositories, making them shareable with the community.
...
```bash
# Run install
npx skills add HartreeWorks/skill--share-skill
